...
namespace GitLeaker.Controllers
{
    ...
    public class ScanController : ControllerBase
    {
        ...
        public ScanController(ScannerService scanner, ReportService report, GitService git)
        {
            _scanner = scanner;
            _report = report;
            _git = git;
    ...
    public class EntropyController : ControllerBase
    {
        ...
        public EntropyController(EntropyService entropy)
        {
            _entropy = entropy;
        }
        ...
        public IActionResult CheckEntropy([FromBody] EntropyCheckRequest request)
        {
            ...
            var entropy = _entropy.Calculate(request.Input);
            var (token, tokenEntropy) = _entropy.ExtractHighEntropyToken(request.Input);
